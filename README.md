...
PS. Я, если и программирую, то только голову людей, но не технику. Сделал, по сути, только адаптацию трудов @Slava-Shchipunov. На большее у меня не хватает времени и знаний.
